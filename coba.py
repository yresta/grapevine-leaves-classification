...
def main():
    ...
    if menu == "Penjelasan":
        ...
        Dataset yang kami gunakan bersumber dari Kaggle https://www.kaggle.com/datasets/muratkokludataset/grapevine-leaves-image-dataset dengan melakukan klasifikasi terhadap lima kelas varietas daun anggur, yaitu Ak, Ala_Idris, Buzgulu, Dimnit, dan Nazli.""")
